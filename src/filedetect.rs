...
const TEXT_EXTENSIONS: &[&str] = &[
    ".asm", ".bat", ".c", ".cfg", ".clj", ".cmake", ".conf", ".cpp", ".cs", ".css", ".csv",
    ".dart", ".diff", ".elm", ".env", ".erl", ".ex", ".exs", ".go", ".graphql", ".h", ".hcl",
    ".hpp", ".html", ".ini", ".java", ".js", ".json", ".jsx", ".kt", ".less", ".lock", ".log",
    ".lua", ".md", ".mk", ".nix", ".patch", ".php", ".pl", ".proto", ".ps1", ".py", ".rb", ".rs",
    ".rst", ".sass", ".sbt", ".scala", ".scss", ".sh", ".sql", ".svelte", ".swift", ".tf", ".toml",
